...
const extraLongHindSystemOne = (entities) => {
    ...
    const leftLineX1 = entities.extraLongHindOne.position[0];
    const leftLineY1 = entities.extraLongHindOne.position[1] + 3;
    const leftLineX2 = entities.extraLongHindOne.position[0];
    const leftLineY2 = entities.extraLongHindOne.position[1] + 30;
    
    // RIGHT LINE OF HINDERANCE BOX
    const rightLineX1 = entities.extraLongHindOne.position[0] + 297;
    const rightLineY1 = entities.extraLongHindOne.position[1] + 3;
    const rightLineX2 = entities.extraLongHindOne.position[0] + 297;
    const rightLineY2 = entities.extraLongHindOne.position[1] + 30;
    
    
    // BOTTOM LINE OF HINDERANCE BOX
    const bottomLineX1 = entities.extraLongHindOne.position[0] + 3;
    const bottomLineY1 = entities.extraLongHindOne.position[1] + 30;
    const bottomLineX2 = entities.extraLongHindOne.position[0] + 297;
    const bottomLineY2 = entities.extraLongHindOne.position[1] + 30;
    
    // TOP LINE OF HINDERANCE BOX
    const topLineX1 = entities.extraLongHindOne.position[0];
    const topLineY1 = entities.extraLongHindOne.position[1];
    const topLineX2 = entities.extraLongHindOne.position[0] + 297;
    const topLineY2 = entities.extraLongHindOne.position[1];
