...
const giantTallSystemOne = (entities) => {
    ...
    const leftLineY2 = entities.longHindTwo.position[1] + 300;

    // RIGHT LINE OF HINDERANCE BOX
    const rightLineX1 = entities.longHindTwo.position[0] + 67;
    const rightLineY1 = entities.longHindTwo.position[1] + 3;
    const rightLineX2 = entities.longHindTwo.position[0] + 67;
    const rightLineY2 = entities.longHindTwo.position[1] + 300;

    // BOTTOM LINE OF HINDERANCE BOX
    const bottomLineX1 = entities.longHindTwo.position[0] + 3;
    const bottomLineY1 = entities.longHindTwo.position[1] + 300;
    const bottomLineX2 = entities.longHindTwo.position[0] + 67;
    const bottomLineY2 = entities.longHindTwo.position[1] + 300;

    // TOP LINE OF HINDERANCE BOX
    const topLineX1 = entities.longHindTwo.position[0];
    const topLineY1 = entities.longHindTwo.position[1];
    const topLineX2 = entities.longHindTwo.position[0] + 67;
