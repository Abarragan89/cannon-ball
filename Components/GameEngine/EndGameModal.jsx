...
const EndGameModal = ( entity, { display }) => {

    function triggerRefresh() {
        entity.display = 'none';
        entity.resetGame = true;
    }
        ...
        <View style={[styles.root, { display: entity.display }]}>
            <View style={styles.modalMainView}>
                ...
                <View style={styles.buttonContainer}>
                    <MainButton runFunc={triggerRefresh}>Retry</MainButton>
                    <MainButton route="/GameScreen/ChapterOne/LevelTwo">Next Level</MainButton>
                </View>
            </View>
        </View>
    )
